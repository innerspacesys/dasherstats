    ...
    content: (
      <div className="space-y-4">
        <div className="bg-gradient-to-br from-gray-800/50 to-gray-800/30 rounded-xl p-6 border border-gray-700/50 text-center">
          ...
          <div className="text-white font-semibold mb-1">Import earnings history</div>
          <div className="text-gray-400 text-sm">
            Upload a spreadsheet or screenshot from your gig apps
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="bg-gray-800/30 rounded-lg p-3 border border-gray-700/30 flex items-center justify-between">
            <div>
              ...
              <div className="text-gray-400 text-xs">12 entries imported</div>
            </div>
          ...
          <div className="bg-gray-800/30 rounded-lg p-3 border border-gray-700/30 flex items-center justify-between">
            <div>
              ...
              <div className="text-gray-400 text-xs">15 entries imported</div>
            </div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-gray-800/30 rounded-lg p-3 border border-gray-700/30">
            <div className="text-gray-400 text-xs mb-1">Avg per entry</div>
        ...
        <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-gray-400">Extra savings</span>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-gray-300 text-sm">Platform use</span>
              <span className="text-blue-400 text-sm font-medium">Multi-app</span>
            </div>
          </div>
        </div>
...
export default function PhoneMockup() {
  ...
  return (
    <div className="relative animate-float">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-blue-600/20 to-transparent rounded-[3rem] pointer-events-none blur-2xl" />
    </div>
  );
}